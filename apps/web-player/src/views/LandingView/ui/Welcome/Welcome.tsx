...
export const Welcome = () => {
  return (
    <div className="hero flex gap-2 items-stretch container p-0 box-border max-lg:grid max-lg:grid-rows-2 -mt-[112px] max-lg:-mt-25">
      <div className="flex-1 p-20 pt-40 rounded-3xl bg-background-secondary mt-2 flex flex-col items-start gap-8 max-lg:p-10 max-lg:pt-35 w-full">
        ...
        <Typography as="p" className="text-xl" size={'body'}>
          {' '}
          Welcome to Bitrate, where music comes alive. Experience a universe of
