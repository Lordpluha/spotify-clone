export const MobileBLock = () => {
  return (
    <div className="relative flex-1 p-20 pt-[160px] rounded-3xl bg-hero-gradient mt-2 flex flex-col items-center border-[#1ED760] border-solid border-2 overflow-hidden">
