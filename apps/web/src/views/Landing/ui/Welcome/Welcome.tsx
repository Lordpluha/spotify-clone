...
export const Welcome = () => {
  return (
    <div className='hero flex gap-2 items-stretch container p-0 box-border max-lg:grid max-lg:grid-rows-2 -mt-[112px] max-lg:-mt-[100px]'>
      ...
      <div
        className="relative flex-1 p-20 pt-[160px] rounded-3xl mt-2 flex flex-col items-center border-green-500 border-solid border-2 overflow-hidden"
        style={{
          background: 'linear-gradient(150deg, #0d2616 0%, var(--color-secondary) 99.04%)'
        }}
      >
        {/* <SpotifyCurvesIcon
