...
const linkCls =
  'underline underline-offset-2 transition-colors duration-300 hover:text-purple-600'
    ...
    <section className="bg-black w-full">
      <div className="w-full max-w-screen-2xl mx-auto">
          ...
          return (
            <VideoCard reverse={false} video={video}>
              <p className={paragraphCls}>
                Turn up your music with Campaign Kit — a set of tools designed
                to drive meaningful metrics for artists and music marketers.
                Expand your reach and build lifelong fans.
              </p>
              <ul className={ulCls}>
        ...
        {(() => {
          ...
          const l = (text: string) => lnk(video.links, text)
          return (
            <VideoCard reverse={true} video={video}>
              <p className={paragraphCls}>
                Invite listeners into your creative world. Customize your artist
                profile, create videos & visuals, and bring the story behind
                your music to life.
              </p>
              <ul className={ulCls}>
                <Description accent={video.accent}>
...
function VideoCard({
  ...
  return (
    <div className="flex items-center py-8 px-6 lg:py-16" id={video.id}>
      <div
        className={`xs:gap-8 lg:flex-row flex flex-col w-full justify-between items-center gap-4 ${reverse ? '' : 'lg:flex-row-reverse'}`}
      >
        ...
        <div className="lg:order-2 order-1 relative group w-full max-w-240 lg:max-w-154">
          ...
          <div
            className="absolute flex justify-end mb-2 bottom-2 right-0 opacity-0 
