...
test('Registration page visual test', async ({ page }) => {
  await page.emulateMedia({ reducedMotion: 'reduce' })

  await page.goto('http://localhost:3002/registration', { waitUntil: 'domcontentloaded' })
  ...
  await expect(page).toHaveScreenshot('landing-registration.png', {
    fullPage: true,
    animations: 'disabled',
    threshold: 0.1,
    maxDiffPixels: 500,
