...
import { TypeWrapperProps, TypeWrapperRef } from './Wrapper.types'
...
const levelStyles = {
	0: 'rounded-xl',
	1: 'm-1 p-2 rounded-xl flex flex-row',
	2: 'p-2 rounded-xl',
	3: 'p-5 rounded-xl'
}

const Wrapper = forwardRef((props: TypeWrapperProps, ref?: TypeWrapperRef) => {
