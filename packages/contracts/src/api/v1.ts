...
export interface paths {
    ...
    "/api/v1/artists/register": {
        ...
        put?: never;
        /** Create a new artist */
        post: operations["ArtistsController_register_v1"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/artists/login": {
        ...
        put?: never;
        /** Login an artist */
        post: operations["ArtistsController_login_v1"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/tracks/play/{id}": {
        ...
        post: operations["TracksController_playTrack_v1"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/tracks/pause/{id}": {
        ...
        post: operations["TracksController_pauseTrack_v1"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/tracks/update-state/{id}": {
        ...
        post: operations["TracksController_updateTrackState_v1"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/tracks/current-state": {
        ...
        get: operations["TracksController_getCurrentState_v1"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface operations {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                     ...
                     *         "backgroundImage": "",
                     *         "bio": "Some bio",
                     *         "createdAt": "2026-01-18T09:41:47.020Z"
                     *       },
                     *       {
                     *         "id": "2",
                     *         "username": "user2",
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                     ...
                     *       "backgroundImage": "",
                     *       "bio": "Some bio",
                     *       "createdAt": "2026-01-18T09:41:47.021Z"
                     *     }
                     */
                    "application/json": unknown;
                };
        ...
        responses: {
            200: {
                ...
                content: {
                     ...
                     *         "audioUrl": "",
                     *         "userId": "",
                     *         "createdAt": "2026-01-18T09:41:47.072Z",
                     *         "updatedAt": "2026-01-18T09:41:47.072Z",
                     *         "duration": 180,
        ...
        responses: {
            201: {
                ...
                content: {
                     ...
                     *       "cover": "https://example.com/cover.jpg",
                     *       "audioUrl": "",
                     *       "createdAt": "2026-01-18T09:41:47.073Z"
                     *     }
                     */
                    "application/json": unknown;
                };
    ...
    TracksController_pauseTrack_v1: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    TracksController_updateTrackState_v1: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    TracksController_getCurrentState_v1: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
