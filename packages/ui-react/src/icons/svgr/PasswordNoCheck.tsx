...
interface PasswordNoCheckProps extends SVGProps<SVGSVGElement> {
  primaryColor?: string
  secondaryColor?: string
}

export const PasswordNoCheck = ({
  primaryColor = "#000000",
  secondaryColor = "#ffffff",
  ...props
}: PasswordNoCheckProps) => (
  <svg
  ...
  >
    <g
      fill={primaryColor}
      clipPath="url(#Dweb-programmingspotifyspotify-clonepackagestokensiconspassword-no-check-a)"
    >
    ...
    <path stroke={primaryColor} d="m19.343 2.364-17 16" />
    <defs>
      <clipPath id="Dweb-programmingspotifyspotify-clonepackagestokensiconspassword-no-check-a">
