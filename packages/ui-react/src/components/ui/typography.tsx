...
export type TypographyFeatureProps =
  | { level: 1 | 2 | 3 | 4 | 5 | 6; as?: undefined; asChild?: false }
...
export const Typography = ({
  ...
  return (
    <Element className={typographyVariants({ size, className })} data-level={level} {...props}>
      {children}
    </Element>
  )
}
