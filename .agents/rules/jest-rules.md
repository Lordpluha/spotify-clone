...
- `/sp-test` — writes one new spec end to end (scaffolds the file, smoke-runs it). Prefer this rule when you just need the conventions to review or hand-write a spec yourself.
