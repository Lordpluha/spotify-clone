...
New feature/entity slices are created by `sp-develop` through the `fsd-scaffold` skill; its
...
Deep doc: `.claude/rules/nestjs-api.md`.
...
Deep doc: the `jest-rules` rule, `.claude/rules/nestjs-api.md`.
...
`apps/web-player` uses co-located Vitest unit specs, global integration specs under
`tests/integration/`, Playwright E2E under `tests/e2e/`, and route screenshots under
`tests/screenshots/`.

Deep docs: the `vitest-rules` rule, the `playwright-rules` rule.
...
Deep doc: the `shadcn-rules` rule; generic reference: the `shadcn` skill.
...
`.claude/rules/fsd-web-player.md`, `.claude/rules/nestjs-api.md`, `.claude/rules/typescript.md`, `.claude/rules/react.md`, `.claude/rules/code-principles.md`, `.claude/rules/styling.md`, `.claude/rules/forms.md`, `.claude/rules/monorepo.md`, `.claude/rules/commit-style.md`, `.claude/rules/architecture-checklist.md`. Sibling references: `jest-rules`, `vitest-rules`, `playwright-rules`, `shadcn-rules`, `api-rules`, `web-player-rules`, `biome-rules`. Workflow skill: `fsd-scaffold`.
